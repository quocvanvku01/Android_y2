...
class FragmentHome : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val setIsLogin = this.activity?.getSharedPreferences("isLogin", 0)
        val getIsLogin = setIsLogin?.getString("isLogin", "")
        val getIIdgv = setIsLogin?.getInt("idgv", 0)
        ...
        if(getIsLogin.equals("")) {
            ...
            //Toast.makeText(this, getIIdgv.toString(), Toast.LENGTH_SHORT).show()
        }
